...
const makeCase = (id, name) => ({
  ...
  reportDraft: {
    reportTitle: `${name} Diagnostic Report` ,
    reportId: `REPORT_${id.toUpperCase().replaceAll("-", "_")}_001`,
    generatedAt: "YYYY-MM-DD HH:mm:ss",
    diagnosis: "FINAL_DIAGNOSIS_PLACEHOLDER",
    confidence: "CONFIDENCE_PLACEHOLDER",
    summary:
      "SUMMARY_PLACEHOLDER: concise pathology narrative generated from WSI classification, patch evidence, and retrieval context.",
    evidenceItems: [
      "EVIDENCE_1_PLACEHOLDER: top attention patch morphology finding.",
      "EVIDENCE_2_PLACEHOLDER: supportive retrieval case pattern.",
      "EVIDENCE_3_PLACEHOLDER: consistency with predicted pathology class.",
    ],
    recommendation:
      "RECOMMENDATION_PLACEHOLDER: suggested clinical follow-up and verification workflow.",
  },
