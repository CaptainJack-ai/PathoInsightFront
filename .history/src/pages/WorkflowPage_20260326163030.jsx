        ...
        <div className="flex h-[calc(100%-5rem)] flex-col gap-6 md:flex-row md:gap-8">
          <aside className="flex h-full md:w-[30%] md:min-w-[320px] md:max-w-[480px] md:items-center">
            <div className="w-full rounded-2xl border border-black/15 bg-white/90 p-6 shadow-[0_12px_50px_rgba(1,1,1,0.08)] md:p-7">
              ...
              <div className="mt-6 space-y-2 rounded-lg border border-black/10 bg-black/5 p-3">
                <input
                  type="file"
                  onChange={(event) => setSelectedFile(event.target.files?.[0] || null)}
                  className="w-full rounded border border-black/20 bg-white px-2 py-1 text-xs"
                />
                <button
                  type="button"
                  onClick={handleUpload}
                  disabled={isUploading}
                  className="w-full rounded bg-black px-3 py-2 text-xs uppercase text-white disabled:opacity-50"
                >
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="min-w-0 flex-1 rounded border border-black/20 bg-white px-2 py-1 text-xs"
                  />
                  <button
                    type="button"
                    onClick={() => {
                ...
                <button
                  ...
                  onClick={stopPolling}
                  disabled={!isPolling}
                  className="w-full rounded border border-black/25 px-3 py-2 text-xs uppercase text-black disabled:opacity-40"
                >
                  Stop Polling
                </button>
