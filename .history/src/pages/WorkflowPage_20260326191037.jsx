      ...
      <div data-retrieval-scroll="true" ref={retrievalRef} onWheel={onCarouselWheel} className="relative z-10 h-full overflow-hidden px-5 pb-6 pt-14 md:px-8">
        <div className="absolute left-1/2 top-1/2 h-[88%] w-full max-w-[1220px] -translate-x-1/2 -translate-y-1/2">
          {displayRows.map((item, idx) => {
            ...
            const scale = absOffset === 0 ? 1 : absOffset === 1 ? 0.62 : absOffset === 2 ? 0.42 : 0.28;
            const opacity = absOffset === 0 ? 1 : absOffset === 1 ? 0.24 : absOffset === 2 ? 0.11 : 0.06;
            const blur = absOffset === 0 ? 0 : absOffset === 1 ? 8 : absOffset === 2 ? 14 : 18;
            ...
            return (
              ...
              >
                <div className="retrieval-shell grid grid-cols-[220px_34px_220px_34px_minmax(0,1fr)] items-center gap-3 rounded-2xl border border-white/20 bg-black/68 p-3 backdrop-blur-sm">
                  <div>
