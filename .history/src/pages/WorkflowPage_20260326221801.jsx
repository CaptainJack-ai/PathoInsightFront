            ...
            return (
              ...
              >
                <div className="retrieval-shell grid grid-cols-[220px_34px_220px_34px_minmax(0,1fr)] items-center gap-3 rounded-2xl bg-gradient-to-r from-black/72 via-black/62 to-black/52 p-3 shadow-[0_14px_36px_rgba(0,0,0,0.3)] backdrop-blur-sm">
                  ...
                  <div className="min-h-[12rem] rounded-xl border border-black/10 bg-gradient-to-br from-white/96 via-[#f3f4f6]/94 to-[#e5e7eb]/92 p-3 shadow-[0_8px_24px_rgba(0,0,0,0.12)]">
                    <p className="text-[10px] uppercase tracking-wider text-black/60">相似病例诊断</p>
                    <p className="mt-2 text-xs text-black/90">{item.similarCaseTitle}</p>
                    <p className="mt-2 text-[11px] text-black/70">{item.similarReportText}</p>
                  </div>
                </div>
              </article>
            );
