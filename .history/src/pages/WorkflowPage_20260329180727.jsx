  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-2xl border border-white/25 bg-black text-blue-100 shadow-[0_20px_80px_rgba(0,0,0,0.32)]">
      <div className="relative h-full overflow-hidden">
        ...
        {isClassifyStep && (
          <div className="absolute left-1/2 top-1/2 z-10 w-[90%] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-yellow-300/60 bg-black/72 px-5 py-4 text-center shadow-[0_0_30px_rgba(0,0,0,0.25)] backdrop-blur-sm animate-pulse sm:w-auto sm:px-8 sm:py-5">
