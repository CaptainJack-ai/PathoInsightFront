  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-2xl border border-white/25 bg-black text-blue-100 shadow-[0_20px_80px_rgba(0,0,0,0.32)]">
      <div className="relative h-full overflow-hidden">
        ...
        {isUploadStep && (
          <div className="absolute bottom-3 left-1/2 w-[95%] max-w-xl -translate-x-1/2 rounded-xl border border-yellow-300/50 bg-black/78 px-3 py-2.5 backdrop-blur-sm sm:bottom-4 sm:w-[92%] sm:px-4 sm:py-3">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            {selectedCase && (
              <button
                ...
                className="rounded-full border border-black/20 px-3 py-1.5 font-general text-[10px] uppercase text-black transition hover:bg-black hover:text-blue-100 sm:px-4 sm:py-2"
              >
                切换病理
              </button>
            )}
