...
const FlowDiagramSection = () => {
  ...
  return (
    <section id="flow-diagram" ref={sectionRef} className="flow-section-bg relative w-screen overflow-hidden py-28 text-blue-50">
      <div className="pointer-events-none absolute inset-0 opacity-60">
        <div className="flow-grid-overlay absolute inset-0" />
        <div className="flow-scanline absolute left-[-45%] top-0 h-full w-1/3 bg-gradient-to-r from-violet-300/0 via-violet-300/20 to-violet-300/0" />
      </div>
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 md:px-10">
        ...
        <div className="relative mt-14 flex justify-center">
          <div className="pointer-events-none absolute -top-24 h-60 w-60 rounded-full bg-violet-300/16 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-16 left-1/2 h-44 w-72 -translate-x-1/2 rounded-full bg-blue-300/12 blur-3xl" />
